...
" Customize status line to include file format
"set statusline=%f\ [%Y]\ [%{&fileformat}]
"set statusline=%<%f\ %h%m%r%=%-14.(%l,%c%V%)\ %P\ [%{&fileformat}]

"hi StatusLine ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE

"set statusline=%f\ [%Y]\ [%{&fileformat}]

"hi StatusLine ctermfg=black ctermbg=black guifg=black guibg=black

"hi StatusLine ctermfg=white ctermbg=0 guifg=white guibg=#000000
